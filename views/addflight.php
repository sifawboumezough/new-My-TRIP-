            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="./avaibleFlights"><i class="fa fa-plane" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Flights</span></a></li>
...
<div class="container">
        <div class="row mt-4">
            <div class="col-md-10 mx-auto ">
                <div class="card">
                    <div class="card-header bg-dark"><span class="text_light">Add Flights</span></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="depart_time" class="text-light">Poste</label>
                            ...
                            <div class="form-group">
                                <label for="arrival_time" class="text-light">Arrival</label>
